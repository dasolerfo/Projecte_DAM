...
public class MenuEdicioDinamic : MonoBehaviour
{
    ...
    public static string rutaUlls = "Assets\\Content\\Sprites\\PersonatgePrincipal\\Ulls";
    private static string[] ulls = Directory.GetFiles(rutaUlls, "*.png");
    public static string rutaRoba = "Assets\\Content\\Sprites\\PersonatgePrincipal\\Roba";
    private static string[] roba = Directory.GetFiles(rutaRoba, "*.png");
    public static string rutaCabells = "Assets\\Content\\Sprites\\PersonatgePrincipal\\Cabells";
    ...
    public void canviApariencia() {
        ...
        GameObject.Find("CreaAnimacions").GetComponent<CreaAnimacions>().rutes[1] = "Assets\\Content\\Sprites\\PersonatgePrincipal\\Base\\base.png";
